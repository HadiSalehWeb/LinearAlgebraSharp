...
namespace LinearAlgebra.Scalars
{
        ...
        where T : struct
    {
        ...
        public static Scalar<int> Rank => Scalar<int>.Zero;
        ...
        static Scalar()
        {
            ...
            switch (scalarType)
            {
                case ScalarType.Boolean:
                    Zero = false;
                    One = true;
                    algebraicStructure = AlgebraicStructure.BooleanAlgebra;
                    break;
        ...
        public Scalar<T> Add(Scalar<T> s)
        {
            ...
            {
                case ScalarType.Boolean:
                    return From(BooleanValue || s.BooleanValue);
                case ScalarType.SByte:
        ...
        public static implicit operator System.Boolean(Scalar<T> value)
        {
            ...
            return value.Cast<System.Boolean>().Value;
        }
